 ...
 */
class TomlParseException(message: String, val line: Int = -1, val column: Int = -1, cause: Throwable? = null) : 
...
class TomlReader {
    ...
    private fun tryParseDateTime(): TomlValue {
        ...
        if (dateTimeStr.contains('T') && (dateTimeStr.contains('+') || dateTimeStr.contains('-') || dateTimeStr.endsWith('Z'))) {
            try {
