...
class JsonTest {
    ...
    fun testJsonRO() {
        ...
        class TestClass {
            ...
            val missingKey by JsonRO(map, Person::class, json) { Person("Default for missingKey", 0) }
        }
    ...
    fun testNullableJsonRO() {
        ...
        class TestClass {
            ...
            val missingKeyWithDefault by NullableJsonRO(map, Person::class, json) { Person("Default for missingKeyWithDefault", 0) }
        }
    ...
    fun testJsonRW() {
        ...
        class TestClass {
            ...
            var missingKey by JsonRW(map, Person::class, json) { Person("Default for missingKey", 0) }
        }
    ...
    fun testNullableJsonRW() {
        ...
        class TestClass {
            ...
            var missingKeyWithDefault by NullableJsonRW(map, Person::class, json) { Person("Default for missingKeyWithDefault", 0) }
        }
